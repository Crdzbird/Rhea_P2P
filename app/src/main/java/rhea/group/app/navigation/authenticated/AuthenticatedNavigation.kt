package rhea.group.app.navigation.authenticated
...
@Composable
fun AuthenticatedNavigation(navigator: ComposeNavigator) {
    val navController = rememberNavController()
    LaunchedEffect(Unit) { navigator.handleNavigationCommands(navController) }
    NavHost(navController = navController, startDestination = Screen.TabHolderScreen.route) {
